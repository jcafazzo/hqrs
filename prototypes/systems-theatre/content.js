...
window.DECK = {
  ...
  slides: [
    {
      title: 'The action', section: 'Act I · Attribution', time: '0', className: 'photo-fill generated-photo brand-monument',
      html: `<img src="../../assets/generated/ai-alert-local-systems.png" alt="Original editorial image of one clinical alert signal appearing across four different hospital contexts"><div class="photo-copy"><p class="eyebrow">One visible action</p><h1 class="hero small">A clinician dismisses the alert.</h1><p class="lede">Why?</p></div><div class="photo-credit"><strong>Original image</strong> · GPT Image 2 · HQRS 846, 2026</div>`,
    ...
    observation({
      title: 'Observe cross-site performance', section: 'Act I · Attribution', time: '3',
      image: '../assets/source-images/theatre/esm-v2-figure-2-v1-comparison.jpg',
      alt: 'Full-screen original JAMA Network Open figure comparing ESM v2 and ESM v1 across four health systems',
      credit: 'Wong et al., 2026 · JAMA Network Open · Figure 2 · CC BY',
      source: theatreSources.ai,
      note: 'Ask students to describe the pattern before giving them the interpretation. Make clear these are four health systems.'
    }),
    {
    ...
    observation({
      title: 'Observe operating points', section: 'Act I · Attribution', time: '6',
      image: '../assets/source-images/theatre/esm-v2-figure-1-performance.jpg',
      alt: 'Full-screen original JAMA figure showing sensitivity, specificity, positive predictive value, and negative predictive value across thresholds at four institutions',
      credit: 'Wong et al., 2026 · JAMA Network Open · Figure 1 · CC BY',
      source: theatreSources.ai,
      note: 'Let students trace one institution across operating points. This slide exists so the graph can actually be read from the back.'
    }),
    {
    ...
    {
      title: 'Put the room to work', section: 'Act II · Stations', time: '8', className: 'photo-fill generated-photo',
      html: `<img src="../../assets/generated/systems-theatre-group.png" alt="Original editorial image of diverse graduate health professionals working in small systems-thinking groups"><div class="photo-copy"><p class="eyebrow">Open the envelopes</p><h1 class="hero wide">Three scenes.<br>Nine tables.<br>Three minutes.</h1><div class="prompt">Cause · redesign · evidence</div></div><div class="photo-credit"><strong>Original image</strong> · GPT Image 2 · HQRS 846, 2026</div>`,
    ...
    {
      title: 'Corridor reveal', section: 'Act II · Stations', time: '13', className: 'photo-fill generated-photo',
      html: `<img src="../../assets/generated/corridor-care.png" alt="Original editorial image of hospital corridor care with beds, equipment, and privacy screens"><div class="photo-copy"><p class="eyebrow">Station A · Environment</p><h1 class="hero small">The corridor is part of the clinical system.</h1><p class="lede">Call bells · sightlines · staffing · oxygen + suction · patient flow</p></div><div class="photo-credit"><strong>Original image</strong> · GPT Image 2 · HQRS 846, 2026</div>`,
    ...
    observation({
      title: 'Observe the temporary environment', section: 'Act II · Stations', time: '13',
      image: '../assets/source-images/theatre/hssib-tce-figure-1-corridor.jpg',
      alt: 'Full-screen original HSSIB photograph of trolleys in a temporary corridor care environment',
      credit: 'HSSIB, 2026 · Figure 1 · temporary care environment',
      source: theatreSources.corridor,
      note: 'Ask students to inventory what the environment affords and what it removes. The photograph is evidence, not scenery.',
      cover: true
    }),
    {
    ...
    observation({
      title: 'Observe fatigue reporting', section: 'Act II · Stations', time: '15',
      image: '../assets/source-images/theatre/hssib-fatigue-figure-1-reporting.png',
      alt: 'Full-screen HSSIB systems diagram of factors affecting fatigue reporting behaviour',
      credit: 'HSSIB, 2025 · Figure 1 · factors affecting fatigue reporting behaviour',
      source: theatreSources.fatigue,
      note: 'Let students find one organizational and one social influence on reporting. Keep the distinction between fatigue hazard and reporting behaviour.'
    }),
    {
    ...
    observation({
      title: 'Observe the frameshift', section: 'Act II · Stations', time: '16',
      image: '../assets/source-images/theatre/ismp-adc-figure-1-frameshift.jpg',
      alt: 'Full-screen ISMP Canada diagram showing the automated dispensing cabinet data frameshift',
      credit: 'ISMP Canada, 2025 · Figure 1 · automated dispensing cabinet frameshift',
      source: theatreSources.adc,
      note: 'Trace one field from intended import to misaligned live data. Then ask where the people interrupted propagation.'
    }),
    {
    ...
    observation({
      title: 'Observe the wider frame', section: 'Act III · Revision', time: '19',
      image: '../assets/source-images/shared/seips-2-figure-1-crop.png',
      alt: 'Full-screen original SEIPS 2.0 work-system model',
      credit: 'Holden et al., 2013 · SEIPS 2.0 · Figure 1 · Required Reading 4',
      source: theatreSources.seips,
      note: 'Ask which boundary the room widened during the activity and which conditions still sit outside the frame.'
    }),
    {
